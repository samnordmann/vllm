...
if TYPE_CHECKING:
    ...
    VLLM_EXPERIMENTAL_NEMOTRON_GATE_LATENT_OVERLAP: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_EXPERIMENTAL_NEMOTRON_GATE_LATENT_OVERLAP": lambda: bool(
        int(os.getenv("VLLM_EXPERIMENTAL_NEMOTRON_GATE_LATENT_OVERLAP", "0"))
    ),
