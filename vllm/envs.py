...
if TYPE_CHECKING:
    ...
    VLLM_EXPERIMENTAL_NEMOTRON_DEFERRED_EP_FINALIZE: bool = False
    VLLM_EXPERIMENTAL_NEMOTRON_DEFERRED_EP_FINALIZE_MAX_TOKENS: int = 128
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_EXPERIMENTAL_NEMOTRON_DEFERRED_EP_FINALIZE": lambda: bool(
        int(os.getenv("VLLM_EXPERIMENTAL_NEMOTRON_DEFERRED_EP_FINALIZE", "0"))
    ),
    "VLLM_EXPERIMENTAL_NEMOTRON_DEFERRED_EP_FINALIZE_MAX_TOKENS": lambda: int(
        os.getenv("VLLM_EXPERIMENTAL_NEMOTRON_DEFERRED_EP_FINALIZE_MAX_TOKENS", 128)
    ),
